...
<!-- Flat Picker -->
<script src="<?= base_url('assets/template/') ?>assets/vendor/libs/moment/moment.js"></script>
<script src="<?= base_url('assets/template/') ?>assets/vendor/libs/flatpickr/flatpickr.js"></script>
