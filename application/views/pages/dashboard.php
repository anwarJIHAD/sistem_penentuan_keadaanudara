...
<div class="container-xxl flex-grow-1 container-p-y">
	<h4 class="py-1 mb-3"><span class="text-muted fw-light">Admin /</span> Account</h4>
	...
	<div class="row gy-4">
		...
		<div class="col-md-12 col-lg-4">
			<div class="card">
				...
				<img src="<?= base_url('assets/') ?>assets/img/icons/misc/triangle-light.png"
				...
				<img src="<?= base_url('assets/') ?>assets/img/illustrations/trophy.png"
		...
		<div class="col-lg-8">
			<div class="card">
				<div class="card-header">
					...
					<p class="mt-3"><span class="fw-medium">Total 48.5% growth</span> 😎 this month
					</p>
				</div>
				<div class="card-body">
					<div class="row g-3">
							...
							<ul class="p-0 m-0">
								<li class="d-flex mb-4 align-items-center pb-2">
									<div class="flex-shrink-0 me-3">
										<img src="<?= base_url('assets/') ?>assets/img/icons/payments/gumroad.png"
								...
								<li class="d-flex mb-4 align-items-center pb-2">
									<div class="flex-shrink-0 me-3">
										<img src="<?= base_url('assets/') ?>assets/img/icons/payments/mastercard-2.png"
								...
								<li class="d-flex mb-4 align-items-center pb-2">
									<div class="flex-shrink-0 me-3">
										<img src="<?= base_url('assets/') ?>assets/img/icons/payments/stripes.png"
								...
								<li class="d-flex mb-4 align-items-center pb-2">
									<div class="flex-shrink-0 me-3">
										<img src="<?= base_url('assets/') ?>assets/img/icons/payments/american-bank.png"
								...
								<li class="d-flex align-items-center">
									<div class="flex-shrink-0 me-3">
										<img src="<?= base_url('assets/') ?>assets/img/icons/payments/citi.png"
					...
					<div class="col-12 col-md-6 ps-0 ps-md-3 mt-3 mt-md-2">
						...
						<div class="pt-2">
							<ul class="p-0 m-0">
								<li class="d-flex mb-4 align-items-center pb-2">
									<div class="flex-shrink-0 me-3">
										<img src="<?= base_url('assets/') ?>assets/img/icons/brands/google.png"
								...
								<li class="d-flex mb-4 align-items-center pb-2">
									<div class="flex-shrink-0 me-3">
										<img src="<?= base_url('assets/') ?>assets/img/icons/brands/github.png"
								...
								<li class="d-flex mb-4 align-items-center pb-2">
									<div class="flex-shrink-0 me-3">
										<img src="<?= base_url('assets/') ?>assets/img/icons/brands/slack.png"
								...
								<li class="d-flex mb-4 align-items-center pb-2">
									<div class="flex-shrink-0 me-3">
										<img src="<?= base_url('assets/') ?>assets/img/icons/payments/digital-ocean.png"
								...
								<li class="d-flex align-items-center">
									<div class="flex-shrink-0 me-3">
										<img src="<?= base_url('assets/') ?>assets/img/icons/brands/aws.png"
