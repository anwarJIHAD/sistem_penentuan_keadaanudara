                    ...
                    <div class="card card-secondary">
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="pendidikan">jenis kelamin</label></br>
                                    <select name="pendidikan" id="pendidikan" class="form-control"
                                        selected="<?= $pkln['pendidikan'] ?>">
                                        <option value="">--------------pilih jenis kelamin------------</option>
                                        <option value="SD" <?php if ($pkln['pendidikan'] == "SD")
                                            echo 'selected = "selected"'; ?>>
                                            SD
                                        </option>

                                        <option value="SMP" <?php if ($pkln['pendidikan'] == "SMP")
                                            echo 'selected = "selected"'; ?>>
                                            SMP</option>
                                        <option value="SMA" <?php if ($pkln['pendidikan'] == "SMA")
                                            echo 'selected = "selected"'; ?>>
                                            SMA
                                        </option>
                                        <option value="SARJANA 1" <?php if ($pkln['pendidikan'] == "SARJANA 1")
                                            echo 'selected = "selected"'; ?>>
                                            SARJANA 1
                                        </option>
                                        <option value="SARJANA 2" <?php if ($pkln['pendidikan'] == "SARJANA 2")
                                            echo 'selected = "selected"'; ?>>
                                            SARJANA 2
                                        </option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="no_kontak" value="<?= $pkln['no_kontak'] ?>"
                                ...
                                <button type="submit" class="btn btn-secondary float-right">Edit Data
