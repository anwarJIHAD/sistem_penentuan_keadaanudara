                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_pmi" value="<?= set_value('nama_pmi'); ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tgl_pengaduan" value="<?= set_value('tgl_pengaduan'); ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="jenis_kasus" value="<?= set_value('jenis_kasus'); ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="p3mi" value="<?= set_value('p3mi'); ?>"
                                        class="form-control" id="p3mi" placeholder="Masukkan p3mi">
                                    <?= form_error('p3mi', '<small class="text-danger pl-3">', '</small>'); ?>
                                </div>
                                <div class="form-group">
                                    <label for="uraian_kasus">Uraian Kasus</label>
                                    <input type="text" name="uraian_kasus" value="<?= set_value('uraian_kasus'); ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="penyelesaian" value="<?= set_value('ket'); ?>"
